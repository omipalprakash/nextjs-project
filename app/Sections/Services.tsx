  ...
  return (
    <section className="relative py-16 sm:py-20 md:py-24 overflow-hidden">
      <div className="absolute inset-0">
        <img src="/delivery-truck.jpg" alt="Delivery truck with pipes" className="w-full h-full object-cover" />
      ...
      <div className="relative container px-4 sm:px-6 text-center">
        <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-green-400 font-medium">Deliver within 24 hours*</p>

          <p className="text-white/70 max-w-xl mx-auto text-sm sm:text-base px-4">
            Our fleet of Express Service Trucks ensures rapid delivery to your job site, minimizing project delays and
            keeping your work on schedule.
          </p>

          <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-8 rounded transition-colors duration-200 inline-flex items-center gap-2 mt-2 sm:mt-4">
