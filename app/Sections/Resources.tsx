import { FileText, Video, Newspaper, BookOpen, Download, ExternalLink } from "lucide-react";
...
const Resources = () => {
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-[#062a47]">
      <div className="container px-4 sm:px-6">
        {/* Header */}
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-white uppercase tracking-wide mb-2">
            Power of Truth
          </h2>
          ...
          <p className="text-white/70 max-w-2xl mx-auto text-sm sm:text-base px-4">
            Pipe products are constructed by materials and tested to standards. Our lab data shows the superior corrosion resistance compared to other pipe materials.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
          {resourceItems.map((item, index) => (
            ...
            >
              <div className={`w-10 h-10 sm:w-14 sm:h-14 ${item.color} rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform`}>
