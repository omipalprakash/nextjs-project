import { FileText, ClipboardList, Calculator, Award, BookOpen, Scale } from "lucide-react"
    ...
    <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
      <div className="container px-4 sm:px-6 mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">STRENGTH OF PERFORMANCE</h2>
          <p className="text-gray-500 text-xs sm:text-sm uppercase tracking-wide mb-3 sm:mb-4">
            Documentation & Resources
          </p>
          <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base px-4">
            All you need to know to design and install, includes SDS, specifications, design tools, CAD details,
            installation instructions, and product information.
          </p>
        </div>
